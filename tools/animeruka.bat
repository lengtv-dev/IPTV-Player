...
echo.
set "URL="
set /p URL=animeruka series URL (e.g. https://animeruka.com/anime/SLUG/):
if "%URL%"=="" goto FETCH
...
echo.
set "CMD=node fetch-animeruka.js %URL% --track=%TRACK% --season=%SEASON% --output=%OUTPUT%"
...
echo.
set "CMD=node fetch-animeruka.js"
